...
fn Home(cx: Scope) -> impl IntoView {
    ...
    cfg_if! {
      if #[cfg(feature = "ssr")] {
        ...
        let chess_board_socket = crate::client::websockets::chess_board::start_websocket(set_chessboard);
    ...
    view! { cx,
      ...
      >
        ...
        <button class="absolute top-16 left-2 z-30 py-2 px-10 rounded bg-neutral-300 hover:bg-neutral-400" on:click=reset>"Reset the Board"</button>
      </div>
    }
}
